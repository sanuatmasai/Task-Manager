                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r from-indigo-50 to-blue-50">
                      <tr>
                        ...
                        <th scope="col" className="px-6 py-3.5 text-center text-xs font-semibold text-indigo-700 uppercase tracking-wider">
                          Due Date
                        </th>
                        <th scope="col" className="px-6 py-3.5 text-center text-xs font-semibold text-indigo-700 uppercase tracking-wider">
                          Priority
                        ...
                        <tr key={task.id} className="hover:bg-indigo-50/30 transition-colors duration-150">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div className="flex items-center justify-end space-x-1">
                              <Link
                                to={`/tasks/${task.id}`}
                                className="text-gray-400 hover:text-gray-600 p-1.5 rounded-lg hover:bg-indigo-50 transition-colors duration-200"
                                title="View details"
                              >
                              ...
                              <Link
                                ...
                                className="text-indigo-400 hover:text-indigo-600 p-1.5 rounded-lg hover:bg-indigo-50 transition-colors duration-200"
                                title="Edit task"
                              >
